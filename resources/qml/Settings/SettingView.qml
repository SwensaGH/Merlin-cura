...
Item
{
    ...
    ListView
    {
        ...
        model: UM.SettingDefinitionsModel
        {
            ...
            exclude: ["machine_settings","experimental", "infill_mesh","material","cooling","support","dual","platform_adhesion", "infill_mesh_order", "cutting_mesh", "support_mesh", "anti_overhang_mesh"] // TODO: infill_mesh settings are excluded hardcoded, but should be based on the fact that settable_globally, settable_per_meshgroup and settable_per_extruder are false.
