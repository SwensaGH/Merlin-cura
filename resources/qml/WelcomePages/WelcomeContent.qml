...
Item
{
    ...
    Column
    {
        ...
        UM.Label
        {
            ...
            text: catalog.i18nc("@label", "Welcome to Merlin Printers")
        ...
        UM.Label
        {
            ...
            text: catalog.i18nc("@text", "Please follow these steps to set up Merlin printers. This will only take a few moments.")
